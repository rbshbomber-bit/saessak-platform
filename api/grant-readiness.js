...
// 입력:
// {
//   userData: { item, strength, funding, prototype, targetGrant, field, region, age, team, customers, revenue, budget, impact },
//   planText: "사업계획서 초안 또는 사용자 메모",
//   listing: { title, org, types, money, deadline, summary, target, regionLabel }
// }
//
// 출력:
// {
//   ok, score, grade, summary, dimensions, requiredInputs, priorityActions, promptPack
// }
...
function buildPromptPack(dimensions) {
